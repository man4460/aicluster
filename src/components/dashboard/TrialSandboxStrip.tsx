...
const stripRootClass =
  "flex min-h-8 w-full items-center gap-2 rounded-[2rem] border border-red-950/20 bg-red-600 px-3 py-1 text-white shadow-sm sm:min-h-9 sm:gap-3 sm:px-4 sm:py-1.5 print:hidden";
