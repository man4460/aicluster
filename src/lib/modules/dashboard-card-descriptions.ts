...
const BY_SLUG: Record<string, string> = {
  ...
  "football-turf": "สนามฟุตบอล · ตารางจอง · walk-in\nโปรโมชั่น รายรับ–รายจ่าย QR",
  ...
  "income-expense-basic": "ค่าน้ำไฟ รถ · ซ่อมบ้าน\nบันทึกส่วนตัว · รหัสผ่าน · โน้ต",
  parking: "รับฝากจอดรถ · QR บัตรลูกค้า\nสมาชิก · บัญชีรายรับ–รายจ่าย",
  "club-event": "กิจกรรมชมรม · สมาชิก การเงิน\nเว็บสาธารณะ /club/[slug]",
  "used-car-showroom": "สต็อก · จอง · ไฟแนนซ์ · P&L\nโชว์รูมออนไลน์ /car/[slug]",
  "smart-guard-tour": "ธุรกิจ รปภ. · จุดตรวจ · สายตรวจ\nกะ · เหตุการณ์ · เว็บ /guard/[slug]",
  "pro-resume": "เรซูเม่ · พอร์ตโฟลิโอ\nเว็บสาธารณะ /resume/[slug]",
  lms: "คอร์สออนไลน์ · บทเรียน YouTube\nข้อสอบ · ใบรับรอง · โควตา 10 คน",
  ...
  "loyalty-stamp": "บัตรสะสมแต้มดิจิทัล\nลูกค้าไม่ต้องโหลดแอป · ร้านกดเพิ่มแต้มง่าย",
  ...
  "general-store-pos": "การ์ดสินค้า · บันทึกขายง่าย\n1 บาท/วัน เมื่อเข้าใช้",
  "drink-pos": "POS เครื่องดื่ม · สะสมแต้มเบอร์โทร\n1 บาท/วัน · ซื้อ 10 แก้วฟรี 1",
  "hotel-resort": "ห้องพัก · จอง เช็คอิน\nบิล QR พร้อมเพย์ · 1 บาท/วัน",
