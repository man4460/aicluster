...
/** จุดตรวจ รปภ. อัจฉริยะ — สายตรวจ GPS · เหตุการณ์ · เว็บ /guard/[slug] */
 ...
 * **ห้าม** ใส่ used-car-showroom / laundry / hotel / smart-guard-tour ฯลฯ ที่นี่ — กันคัดลอกลิงก์แล้วดาวน์เกรด
 */
...
export function displayAppModuleTitle(slug: string, title: string): string {
  ...
  if (slug === SMART_GUARD_TOUR_MODULE_SLUG) return "จุดตรวจ รปภ. อัจฉริยะ";
...
/** ข้อความการ์ดสายรายวัน ในหน้าแพ็กเกจ */
export const DAILY_LINE_PLAN_SUMMARY = {
  title: "สายรายวัน",
  subtitle: "หักต่อโมดูลเมื่อเข้าใช้",
  lines: [
...
/** สิทธิ์แพ็ก 199 ต่อโมดูล — ตามเงื่อนไขที่แอดมินตั้ง ไม่เหมาทั้งระบบ */
export const MONTHLY_199_PLAN_FEATURE_LINES = [
  `ข้อมูลได้มากกว่า ${PLAN_MONTHLY_DATA_ROWS_THRESHOLD.toLocaleString("th-TH")} แถว (ตามที่แอดมินตั้ง)`,
  "พิมพ์สลิป / อัปโหลดสลิปและเอกสาร — เมื่อแอดมินเปิดเงื่อนไขเหล่านี้",
  "หัก 199 โทเคนต่อโมดูลต่อเดือน — สมัครร้านอาหาร + เครื่องดื่ม = 199 + 199",
  "โมดูลที่สมัคร 199 แล้วไม่หัก 1 บาท/วัน ของโมดูลนั้น",
] as const;
