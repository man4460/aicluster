      ...
      <AppUsageGuideModal
        ...
        sections={[
          ...
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>
                  <strong>แดชบอร์ด</strong> — สถิติเข้าชม · ผลงานยอดนิยม · ทางลัดแก้ไข
                </li>
                <li>
                ...
                <li>
                  <strong>ตั้งค่า</strong> — slug · เปิด/ปิดเว็บ · ลิงก์/QR · ธีม
                </li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>จำนวนการเข้าชมเว็บเรซูmé — รายวัน/รวม · แหล่งที่มา (ถ้ามี)</li>
                <li>ผลงานที่ถูกเปิดดูบ่อย — ใช้จัดลำดับใน portfolio</li>
                <li>ทางลัดไป โปรไฟล์ · ผลงาน · ตั้งค่า</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>ข้อมูลส่วนตัว — ชื่อ · ตำแหน่ง · อีเมล · เบอร์ · รูปโปรไฟล์</li>
                <li>การศึกษา — สถาบัน · สาขา · ปีจบ · เรียงลำดับได้</li>
                <li>ประสบการณ์ — บริษัท · บทบาท · ช่วงเวลา · คำอธิบาย</li>
                <li>ใบรับรอง — ชื่อ · องค์กร · ปี · ลิงก์ตรวจสอบ</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>สร้างหมวด — เช่น Web · Design · งานวิจัย</li>
                <li>เพิ่มรายการ — ชื่อ · คำอธิบาย · รูปปก · ลิงก์ demo/GitHub</li>
                <li>เรียงลำดับ — ลากหรือกำหนดลำดับแสดงบนหน้าสาธารณะ</li>
                <li>ปิด/เปิดรายการ — ซ่อนงานเก่าโดยไม่ลบ</li>
              </ul>
            ),
          },
          {
            title: "เมนู: ตั้งค่า · แชร์ลิงก์",
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>ตั้ง slug — URL สาธารณะ `/resume/[slug]` · ตรวจความซ้ำก่อนบันทึก</li>
                <li>เปิด/ปิดเว็บ — แพ็กรายเดือนจึงเผยแพร่ได้ · อัปเกรดที่หน้าแพ็กเกจ</li>
                <li>คัดลอกลิงก์ · QR — แชร์ให้ HR หรือใส่ในเรซูmé PDF</li>
                <li>ตัวอย่างก่อนเผยแพร่ — ดูว่าหน้าสาธารณะแสดงครบหรือไม่</li>
              </ul>
            ),
          },
        ]}
