...
export type ProResumeCardToneClasses = {
  leftBorder: string;
  bg: string;
  iconBg: string;
  iconText: string;
...
const TONES: Record<ProResumeCardTone, ProResumeCardToneClasses> = {
  sky: {
...
export function proResumeCardToneClasses(tone: ProResumeCardTone): ProResumeCardToneClasses {
  return TONES[tone];
}

export function proResumeTonedRowCardClass(tone: ProResumeCardTone): string {
  const t = proResumeCardToneClasses(tone);
  return cn(
...
export function proResumeCardIconTileClass(tone: ProResumeCardTone, size: "md" | "lg" = "md"): string {
  const t = proResumeCardToneClasses(tone);
  return cn(
