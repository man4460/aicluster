export type EcommerceNavSection = "dashboard" | "settings" | "products" | "orders" | "customers";
...
export const ECOMMERCE_NAV_LINKS: {
  ...
  { href: "/dashboard/ecommerce-store", section: "dashboard", label: "ภาพรวม" },
  { href: "/dashboard/ecommerce-store/products", section: "products", label: "สินค้า" },
  { href: "/dashboard/ecommerce-store/orders", section: "orders", label: "ออเดอร์" },
