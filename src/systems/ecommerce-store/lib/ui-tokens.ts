...
export const ecommerceStoreGlassShellClass =
...
export const ecommerceStoreMainPaddingBottomClass = "pb-48 lg:pb-0";

export const ecommerceStoreSectionRadiusClass = "!rounded-[2rem]";

export const ecommerceStoreDockPillClass = "!rounded-[1.5rem]";

export const ecommerceStoreNavActiveClass = cn(
  appDashboardBrandGradientFillClass,
  "text-white shadow-md ring-1 ring-white/40",
);

export const ecommerceStoreNavIdleClass = "text-slate-500 hover:bg-white/45 hover:text-slate-700";

export const ecommerceStoreModuleIconBadgeClass = cn(
