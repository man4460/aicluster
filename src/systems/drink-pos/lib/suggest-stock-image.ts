 ...
 */
import { DRINK_POS_DEFAULT_IMAGE } from "@/lib/drink-pos/drink-stock-images";

const U = {
  coffee:
    "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=800&q=72",
  tea: "https://images.unsplash.com/photo-1544787219-7f47ccb76574?auto=format&fit=crop&w=800&q=72",
  waterBottle:
  ...
  meat: "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=800&q=72",
  seafood:
  ...
  stationery:
    "https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=800&q=72",
  household:
  ...
  food:
    "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=72",
  defaultStore: DRINK_POS_DEFAULT_IMAGE.replace("q=78", "q=72"),
} as const;
...
export function suggestDrinkPosStockImageUrl(input: { name: string; categoryName?: string | null }): string {
