...
import { bookingUiLabel, type MassageBookingStatusUi } from "@/lib/massage/booking-status";

export function MassageBookingStatusBadge({
  status,
  scheduledAt,
  ...
  const ui = bookingUiLabel(
    status as MassageBookingStatusUi,
    scheduledAt,
