...
export const PERSONAL_AI_CHAT_ROOT_CLASS =
  "relative flex max-h-full min-h-0 flex-1 flex-col gap-2.5 overflow-hidden text-slate-800 lg:h-full lg:flex-row lg:items-stretch lg:gap-3 lg:rounded-2xl lg:bg-gradient-to-br lg:from-[#f3f1fc] lg:via-[#faf9ff] lg:to-[#ebe8f7]/90 lg:p-1.5 lg:ring-1 lg:ring-[#e4e2f5]/80";
...
export const PERSONAL_AI_CHAT_DIGEST_ASIDE_CLASS =
  "order-1 flex min-h-0 max-h-[min(46vh,24rem)] w-full min-w-0 shrink-0 flex-col overflow-hidden rounded-2xl border border-[#dcd7f0] bg-gradient-to-b from-[#faf9ff] via-[#f3f1fc] to-[#e8e4f7] shadow-xl shadow-indigo-950/[0.09] ring-1 ring-white/70 lg:h-full lg:max-h-none lg:w-72 lg:min-w-[18rem] xl:w-80";
...
export const PERSONAL_AI_CHAT_CARD_SHELL_CLASS =
  "order-2 flex min-h-[min(56vh,30rem)] min-w-0 max-h-full flex-1 flex-col overflow-hidden rounded-2xl border border-[#e4e2f5] bg-white shadow-lg shadow-indigo-950/[0.08] ring-1 ring-white/80 lg:h-full lg:min-h-0";
