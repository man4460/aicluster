...
export type UsedCarShowroomCardTone =
  | "sky"
  | "violet"
  | "emerald"
  | "rose"
...
export type UsedCarShowroomCardToneClasses = {
  leftBorder: string;
  bg: string;
  iconBg: string;
  iconText: string;
...
const TONES: Record<UsedCarShowroomCardTone, UsedCarShowroomCardToneClasses> = {
  sky: {
...
export function usedCarShowroomCardToneClasses(tone: UsedCarShowroomCardTone): UsedCarShowroomCardToneClasses {
  return TONES[tone];
}

/** @deprecated alias */
export const UsedCarShowroomCardToneClasses = usedCarShowroomCardToneClasses;

/** เปลือกการ์ดรายการ — เส้นซ้าย + พื้นโทน */
export function usedCarShowroomTonedRowCardClass(tone: UsedCarShowroomCardTone): string {
  const t = usedCarShowroomCardToneClasses(tone);
  return cn(
...
/** @deprecated alias */
export const UsedCarShowroomTonedRowCardClass = usedCarShowroomTonedRowCardClass;

/** การ์ดในกริด (คำตอบ · สรุปคำถาม · รายคน) — คอลัมน์กระชับ */
export function usedCarShowroomTonedGridCardClass(tone: UsedCarShowroomCardTone): string {
  const t = usedCarShowroomCardToneClasses(tone);
  return cn(
...
/** @deprecated alias */
export const UsedCarShowroomTonedGridCardClass = usedCarShowroomTonedGridCardClass;

/** กล่องไอคอนมุมซ้ายการ์ด */
export function usedCarShowroomCardIconTileClass(tone: UsedCarShowroomCardTone, size: "md" | "lg" = "md"): string {
  const t = usedCarShowroomCardToneClasses(tone);
  return cn(
...
/** @deprecated alias */
export const UsedCarShowroomCardIconTileClass = usedCarShowroomCardIconTileClass;
