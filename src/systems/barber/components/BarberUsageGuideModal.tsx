          ...
          <div className="space-y-5">
            <Section title="แนะนำลำดับเริ่มต้น">
              ...
              <ol className="list-decimal space-y-1 pl-5 marker:font-semibold marker:text-[#4d47b6]">
                ...
                <li>การจัดการ — ช่าง · แพ็กเกจ · สมาชิก</li>
                <li>แดชบอร์ด (แท็บคิว / เช็กอิน) และเมนู QR — ตาม workflow ร้าน</li>
              </ol>
            </Section>
            ...
            <Section title="แดชบอร์ด">
              <p>
                ...
                (จัดการช่างอยู่ที่เมนู <strong className="font-semibold text-[#2e2a58]">การจัดการ</strong>)
              </p>
            ...
            <Section title="แท็บในแดชบอร์ด: เช็กอิน">
              ...
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>
                  <strong className="font-semibold text-[#2e2a58]">ช่างที่บันทึก</strong> — เลือกช่างจากรายการ (ตั้งได้ที่การจัดการ → ช่าง)
                ...
                <li>
                  ...
                  เปิดสมาชิกแพ็กใหม่ (ต้องมีแพ็กเกจในระบบก่อน — สร้างที่การจัดการ → แพ็กเกจ)
                </li>
              </ul>
            </Section>

            <Section title="เมนูการจัดการ (ช่าง · แพ็กเกจ · สมาชิก)">
              <p>
                เมนู <strong className="font-semibold text-[#2e2a58]">การจัดการ</strong> รวมสามแท็บในแผงเดียว:{" "}
                <strong className="font-semibold text-[#2e2a58]">ช่าง</strong> ·{" "}
                <strong className="font-semibold text-[#2e2a58]">แพ็กเกจ</strong> ·{" "}
                <strong className="font-semibold text-[#2e2a58]">สมาชิกแพ็กเกจ</strong>
              </p>
              <p className="font-semibold text-[#2e2a58]">แท็บช่าง</p>
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
