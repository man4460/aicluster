            ...
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  ...
                  <li>เมื่อชำระครบ กด «พิมพ์» เพื่อออกใบเสร็จหรือใบกำกับภาษี</li>
            ...
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  ...
                  <li>
                    เมื่อชำระครบแล้ว กด <strong className="font-semibold text-[#2e2a58]">พิมพ์</strong> —
                    ใบเสร็จ/สลิปทั่วไปใช้ขนาดกระดาษจากแท็บตั้งค่า · ใบกำกับภาษีใช้ A4 และต้องกรอกที่อยู่กับเลขผู้เสียภาษีลูกค้า
                  </li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  ...
                  <li>ขายโปรที่เคาน์เตอร์แล้วตัดสิทธิ์จากแดชบอร์ด/หน้าพนักงานด้วยเบอร์เดิม</li>
