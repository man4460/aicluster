        ...
        <AppUsageGuideModal
          ...
          sections={[
              ...
              content: (
                <>
                  ...
                  <ol className="list-decimal space-y-1.5 pl-5 marker:font-semibold marker:text-[#4d47b6]">
                    ...
                    <li>
                      เพิ่มสนามในแท็บ <strong className="font-semibold text-[#2e2a58]">ภาพรวม</strong> — เวลาเปิด–ปิด ·
                      ความยาวคิว (นาที) · ราคา
                    </li>
                    <li>
            ...
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>
                    แท็บหลัก: ภาพรวม · คิว · การเงิน · โปรโมชั่น · ลูกค้า · QR / ลิงก์ · ตั้งค่า
                  </li>
                  <li>
            ...
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  ...
                  <li>จัดการสนาม: ชื่อ · เวลาเปิด–ปิด · ความยาวสล็อต · ราคาต่อรอบ</li>
            ...
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>ติดตามสถานะรอบ: จองแล้ว → เช็กอิน → กำลังเล่น → เสร็จสิ้น (หรือยกเลิก)</li>
                  <li>เช็กอิน / เริ่มเล่น / จบรอบจากแดชบอร์ดได้เมื่อถึงช่วงเวลาที่เหมาะสม</li>
                  <li>คิวที่หมดเวลาแล้วจะไม่ให้เช็กอินหรือใช้สิทธิ์โปรต่อ</li>
                  <li>ถ้าคิวผูกโปรโมชั่นแล้ว จะแสดงว่าใช้สิทธิ์แล้ว — ไม่ตัดซ้ำ</li>
                </ul>
              ),
            },
            {
