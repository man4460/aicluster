          ...
          sections={[
            {
              ...
              content: (
                <>
                  <p>
                    เริ่มจากตั้ง <strong className="font-semibold text-[#2e2a58]">แพ็กเกจ</strong> ในเมนูแพ็กเกจ
                    แล้วใช้ <strong className="font-semibold text-[#2e2a58]">ภาพรวม</strong> รับรถรายวัน · ติดตามผลที่{" "}
                    <strong className="font-semibold text-[#2e2a58]">การเงิน</strong> · ตั้ง QR ที่{" "}
                    <strong className="font-semibold text-[#2e2a58]">ตั้งค่าร้าน</strong>
                  </p>
                  <ol className="list-decimal space-y-1.5 pl-5 marker:font-semibold marker:text-[#4d47b6]">
                    <li>เมนู แพ็กเกจ — สร้างบริการและราคา · ตั้งแพ็กเหมา/สมาชิก</li>
                    <li>เมนู ภาพรวม — รับรถ · บันทึกบริการ · ติดตามสถานะในลาน</li>
                    <li>เมนู การเงิน — ดูรายการขาย · บันทึกต้นทุน · กราฟรายได้–ต้นทุน</li>
                    <li>เมนู ตั้งค่าร้าน — QR พนักงาน/ลูกค้า · เวลาเปิด · ข้อมูลร้าน</li>
                  </ol>
                </>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>
                    <strong>ภาพรวม</strong> — สถิติวันนี้ · ลานรถ · รับงาน · คิว
                  </li>
                  <li>
                    <strong>การเงิน</strong> — รายการขาย · ต้นทุน · กราฟ · พิมพ์
                  </li>
                  <li>
                    <strong>แพ็กเกจ</strong> — บริการ · ราคา · แพ็กเหมา/สมาชิก
                  </li>
                  <li>
                    <strong>ตั้งค่าร้าน</strong> — ข้อมูลร้าน · QR · เวลาเปิด
                  </li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>การ์ดสรุปวันนี้ — จำนวนคิว · รายรับ · แพ็กที่ใช้ (กริด 2 คอลัมน์บนมือถือ)</li>
                  <li>ลานรถ — สถานะ กำลังล้าง · รอชำระ · เสร็จแล้ว · ลากหรือกดเปลี่ยนสถานะ</li>
                  <li>รับรถใหม่ — เลือกแพ็ก · ทะเบียน · ลูกค้า · หักแพ็กเหมา (ลงนามก่อนหัก)</li>
                  <li>หน้าหลักพนักงานรับรถ — โหมด staff lane เห็นเฉพาะภาพรวม+แพ็ก</li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>แท็บรายการขาย — ประวัติย้อนหลัง · กรองช่วงวันที่ · แก้ไขบิล/สลิป</li>
                  <li>แท็บต้นทุน — บันทึกน้ำยา · ค่าแรง · ค่าใช้จ่ายประจำวัน</li>
                  <li>กราฟรายได้–ต้นทุน — โหมด compact · ดูสุทธิกำไรรายวัน</li>
                  <li>พิมพ์ใบเสร็จ/ใบกำกับ — ตามกฎแพ็กสมาชิก (ใบเดียวตามที่ติ๊ก)</li>
                  <li>ปุ่มแสดง/ซ่อนกรอง — ทุก breakpoint</li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>
                    <strong>แพ็กบริการ</strong> — ล้างธรรมดา · เคลือบ · ดูดฝุ่น · ราคา · ระยะเวลา · เปิด/ปิด
                  </li>
                  <li>
                    <strong>แพ็กเหมา/สมาชิก</strong> — ขายหลายครั้ง · ติดตามสิทธิ์คงเหลือ · ชื่อ+คำอธิบายบนการ์ด
                  </li>
                  <li>หักแพ็ก — บังคับลายเซ็นลูกค้าก่อนหัก · บันทึกชื่อแพ็กใน note</li>
                  <li>ขายแพ็ก — เลือกใบเสร็จหรือใบกำกับ · พิมพ์อย่างใดอย่างหนึ่งหลังบันทึก</li>
                </ul>
              ),
            },
            {
              title: "เมนู: ตั้งค่าร้าน",
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>ข้อมูลร้าน — ชื่อ · ที่อยู่ · เบอร์ · โลโก้ · ขนาดกระดาษสลิป</li>
                  <li>QR พนักงาน — ลิงก์หน้าลาน · โปสเตอร์ติดจุดทำงาน</li>
                  <li>QR ลูกค้า — จองคิว/เลือกแพ็ก · ใช้แพ็กเหมา · คัดลอก/ดาวน์โหลดโปสเตอร์</li>
                  <li>เวลาเปิดร้าน — ใช้ AppTime24Input · เวลาไทย</li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>เห็นเฉพาะ ภาพรวม และ แพ็ก — เหมาะมือถือหน้างาน</li>
                  <li>ไม่เข้าถึงการเงิน/ตั้งค่าเต็ม — ลดความเสี่ยงแก้ข้อมูลสำคัญ</li>
                  <li>Live SSE — อัปเดตลานหลายเครื่องพร้อมกัน</li>
                </ul>
              ),
            },
            {
              ...
              content: (
                <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                  <li>ก่อนปิดร้าน — ตรวจรถค้างลาน · ยอดชำระค้าง · แพ็กใกล้หมดสิทธิ์</li>
                  <li>กดรีเฟรชเมื่อหลายเครื่องใช้งานพร้อมกัน</li>
                  <li>ทบทวนรายรับสุทธิจากเมนู การเงิน ทุกสิ้นวัน</li>
                </ul>
              ),
            },
          ]}
