...
export const CAR_WASH_SETTINGS_LINK_HREF = `${CAR_WASH_SETTINGS_PATH}?tab=link`;
...
export type CarWashTabKey = "overview" | "finance" | "offers";
...
export function parseCarWashTab(value: string | null | undefined): CarWashTabKey {
  if (value === "finance" || value === "offers") return value;
  return "overview";
}
