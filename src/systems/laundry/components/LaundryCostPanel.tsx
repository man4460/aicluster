...
>(function LaundryCostPanel(
  ...
  const [editCat, setEditCat] = useState<LaundryCostCategory | null>(null);
  ...
  const [editEntry, setEditEntry] = useState<LaundryCostEntry | null>(null);
  ...
  const openEditCategoryForm = useCallback((c: LaundryCostCategory) => {
    setEditCat(c);
    setCatName(c.name);
  }, []);
  ...
  const openEditEntry = useCallback((e: LaundryCostEntry) => {
    setEditEntry(e);
    setEditEntryForm({
