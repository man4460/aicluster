...
export const clubEventPortalLabelClass = "block text-xs font-bold text-[#4d47b6]";

export const clubEventPortalPublicFieldClass = cn(
...
export const clubEventPortalPublicTextareaClass = cn(
