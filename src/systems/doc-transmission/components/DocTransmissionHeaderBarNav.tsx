...
export function DocTransmissionHeaderExpandButton({ onExpand }: { onExpand: () => void }) {
  return (
    <button
      type="button"
      onClick={onExpand}
...
export function DocTransmissionHeaderBarNav({ onExpand }: { onExpand: () => void }) {
  ...
  return (
    <div className="flex min-w-0 flex-1 items-center gap-1 sm:gap-2">
      <nav
        ...
        aria-label="เมนูโมดูลสารบรรณดิจิทัล"
      >
      ...
      <DocTransmissionHeaderExpandButton onExpand={onExpand} />
    </div>
  );
}
