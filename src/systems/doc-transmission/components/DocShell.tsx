        ...
        sections={[
          {
            ...
            content: (
              <>
                <p>
                  ตั้งข้อมูลหลักก่อน → กำหนด Prefix เลขที่ → สร้างเอกสาร → ดำเนินการผ่าน timeline → ดูสรุปที่{" "}
                ...
                <ol className="list-decimal space-y-1.5 pl-5 marker:font-semibold marker:text-[#4d47b6]">
                  <li>เมนู ข้อมูลหลัก — เพิ่มหน่วยงาน/แผนก · ผู้รับผิดชอบ · หมวดเอกสาร</li>
                  <li>เมนู ข้อมูลหลัก (ตั้งค่า) — ชื่อองค์กร · Prefix เลขที่หนังสือ · ปีงบประมาณ</li>
                  <li>เมนู เอกสาร — สร้างหนังสือใหม่ · ระบบออกเลขอัตโนมัติ · แนบ PDF</li>
                  <li>เปิดรายละเอียด → timeline (ลงรับ → มอบหมาย → เสร็จ) · Share ลิงก์สาธารณะ</li>
                  <li>เมนู แดชบอร์ด — ดูค้าง · เลยกำหนด · สถิติหมวด</li>
                </ol>
              </>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>
                  <strong>แดชบอร์ด</strong> — ภาพรวมสถานะ · เลยกำหนด · สถิติหมวด · งานค้าง
                </li>
                <li>
                  <strong>เอกสาร</strong> — สร้าง/ค้นหา/กรอง · timeline · ไฟล์แนบ · Share
                </li>
                <li>
                  <strong>ข้อมูลหลัก</strong> — หน่วยงาน · แผนก · ตั้งค่าเลขที่ · Prefix
                </li>
                <li>
                  <strong>รายงาน</strong> — ส่งออก CSV · สรุปตามหมวด/ปี/ช่วงวันที่
                </li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>การ์ดสรุป — รอดำเนินการ · เสร็จแล้ว · เลยกำหนด · ตามหมวด</li>
                <li>รายการเร่งด่วน — เอกสารใกล้ครบกำหนด · คลิกเข้า timeline ได้ทันที</li>
                <li>กราฟ/สถิติตามหมวด — คำสั่ง · บันทึกข้อความ · รับเข้า · ส่งออก · หนังสือเวียน</li>
                <li>ทางลัดไป เอกสาร หรือ รายงาน จากปุ่มหัวการ์ด</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>สร้างใหม่ — เลือกหมวด · ระบบออกเลขที่ + tracking code/QR อัตโนมัติ</li>
                <li>ค้นหา/กรอง — หมวด · ปี · สถานะ · ความเร่งด่วน · หน่วยงาน · คำค้น</li>
                <li>Timeline — ลงรับ → มอบหมาย → ดำเนินการ → เสร็จ · บันทึกผู้ดำเนินการ + เวลา</li>
                <li>ไฟล์แนบ PDF — เก็บ revision · ดูย้อนหลังได้ · Audit log ทุกการแก้ไข</li>
                <li>Share — ลิงก์ read-only ให้คนนอกระบบดูเอกสาร · กำหนด due date ได้</li>
              </ul>
            ),
          },
          {
            title: "เมนู: ข้อมูลหลัก",
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>หน่วยงาน/แผนก — ชื่อ · รหัส · ผู้รับผิดชอบ · ใช้มอบหมายใน timeline</li>
                <li>ตั้งค่า — ชื่อองค์กร · Prefix เลขที่หนังสือ (running ต่อปี/หมวด)</li>
                <li>หมวดเอกสาร — สอดคล้องงานสารบรรณจริง · แยกคำสั่ง/บันทึก/รับเข้า/ส่งออก/เวียน</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>สรุปตามหมวด · ปี · ช่วงวันที่ · สถานะ</li>
                <li>Export CSV — ทั้งหมดหรือเฉพาะที่กรอง · เปิดใน Excel</li>
                <li>ใช้ตรวจสอบย้อนหลัง · ส่งผู้บริหาร · ประกอบการตรวจสอบ</li>
                <li>Audit log จากเอกสารแต่ละฉบับเชื่อมกับรายงานรวม</li>
              </ul>
            ),
          },
        ]}
