...
function navIcon(key: AssetNavKey, className?: string): ReactNode {
  switch (key) {
    case "dashboard":
...
export function AssetHeaderExpandButton({ onExpand }: { onExpand: () => void }) {
  return (
    <button
      type="button"
      onClick={onExpand}
...
export function AssetHeaderBarNav({ onExpand }: { onExpand: () => void }) {
