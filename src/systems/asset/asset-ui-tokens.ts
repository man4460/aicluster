...
export const assetMobileDockShellClass =
...
export const assetDockItemActiveClass =
  "bg-white/80 text-[#5b61ff] shadow-md ring-1 ring-[#5b61ff]/20 backdrop-blur-sm";

export const assetDockItemIdleClass = "text-slate-500 hover:bg-white/45 hover:text-slate-700";
