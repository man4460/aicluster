 ...
 * โทน UI บริหารทรัพย์สิน — สอดคล้องคาร์แคร์ / template กลาง (ม่วง MAWELL)
...
export const assetCardSurfaceRadiusClass = "rounded-[2rem]";

export const assetCardLargeRadiusClass = "rounded-[2.5rem]";

export const assetInsetControlRadiusClass = "rounded-[1.25rem]";



export const assetModuleHeaderShellClass =
...
export const assetNavItemActiveClass =

  "bg-white/75 text-[#5b61ff] shadow-md ring-1 ring-[#5b61ff]/20 backdrop-blur-sm";



export const assetNavItemIdleClass = "app-btn-soft text-[#66638c] hover:bg-white/55 hover:text-[#4d47b6]";



export {
  appMobileDockBackdropClass as assetMobileDockShellClass,
  appMobileDockPillClass as assetMobileDockPillClass,
  appMobileDockGridClass as assetMobileDockGridClass,
  appMobileDockItemActiveClass as assetDockItemActiveClass,
  appMobileDockItemIdleClass as assetDockItemIdleClass,
} from "@/components/app-templates/mobile-dock-tokens";



export const assetIconBadgeClass =
...
export function assetFilterChipClass(active: boolean) {
...
export const assetSegmentShellClass =

  `${assetCardSurfaceRadiusClass} border border-white/55 bg-white/40 p-1.5 backdrop-blur-md sm:p-2`;



export const assetListRowCardClass =

  `${assetCardSurfaceRadiusClass} border border-white/60 bg-white/55 p-3 shadow-sm backdrop-blur-sm ring-1 ring-inset ring-white/50 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/70 hover:shadow-[0_16px_34px_-24px_rgba(30,27,75,0.35)] sm:p-4`;



export const assetListRowCardWarnClass =

  `${assetCardSurfaceRadiusClass} border border-rose-200/80 bg-gradient-to-br from-rose-50/80 to-white/70 p-3 shadow-sm ring-1 ring-rose-100/70 backdrop-blur-sm sm:p-4`;



export const assetEmptyDashedClass =

  `${assetInsetControlRadiusClass} border border-dashed border-white/60 bg-white/35 px-4 py-10 text-center text-sm leading-relaxed text-[#66638c] backdrop-blur-sm`;



export const assetFieldClass =
...
export function assetStatCardClass(tone: "violet" | "slate" | "amber" | "emerald" | "rose" | "indigo") {
...
export const assetAlertToneClass: Record<"rose" | "amber" | "slate", string> = {

  rose: `${assetInsetControlRadiusClass} border border-rose-200/80 bg-gradient-to-br from-rose-50/70 to-white/60`,

  amber: `${assetInsetControlRadiusClass} border border-amber-200/80 bg-gradient-to-br from-amber-50/70 to-white/60`,

  slate: `${assetInsetControlRadiusClass} border border-white/60 bg-white/55 backdrop-blur-sm`,
