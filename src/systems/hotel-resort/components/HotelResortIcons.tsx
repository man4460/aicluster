/** ไอคอนร่วมโมดูลโรงแรม / รีสอร์ท */

export function IconHotel({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      <path d="M3 13h18v6H3zM5 13V8a2 2 0 012-2h5a2 2 0 012 2v5M3 19v2M21 19v2" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconBuilding({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      <path d="M4 20V6l8-3 8 3v14M9 20v-4h6v4" strokeLinejoin="round" />
      <path d="M9 10h.01M15 10h.01M9 14h.01M15 14h.01" strokeLinecap="round" />
    </svg>
  );
}

export function IconDoorOpen({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
...
export function IconKey({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      ...
      <path d="M12 15h9M17 15v3M20 12v3" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconQr({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      ...
      <path d="M14 14h2v2h-2zM18 14h2v6h-6v-2" strokeLinejoin="round" />
    </svg>
  );
}

export function IconSearchGuest({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      <circle cx="10" cy="8" r="3.5" />
      <path d="M4 20c0-3.3 2.7-6 6-6s6 2.7 6 6" strokeLinecap="round" />
      <path d="M18 18l3 3" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconNavCheckIn({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
...
export function IconNavFinance({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
...
export function IconNavGuest({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
...
export function IconIdCard({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} aria-hidden>
      ...
      <path d="M14 10h4M14 14h4M6 17c0-2 1.5-3 3-3s3 1 3 3" strokeLinecap="round" />
    </svg>
  );
}
