  ...
  return (
    <div className={cn("flex min-w-0 flex-col gap-4 sm:gap-6", "max-lg:pb-24 lg:pb-0")}>
      ...
      <AppUsageGuideModal
        ...
        title="คู่มือการใช้งาน — จุดตรวจ รปภ. อัจฉริยะ"
        subtitle="แดชบอร์ด · การจัดการ · การเงิน · ตั้งค่า · ลิงก์ /guard/[slug]"
        sections={[
          {
            title: "ลำดับเริ่มต้นแนะนำ",
            content: (
              <ol className="list-decimal space-y-1.5 pl-5 marker:font-semibold marker:text-orange-700">
                <li>ตั้งค่าพื้นฐาน + พร้อมเพย์/บัญชี + เบอร์ฉุกเฉิน</li>
                <li>ตั้งค่าเว็บไซต์ — slug · เปิดพอร์ทัล · SOS</li>
                <li>เพิ่มจุดตรวจ · พนักงาน · ตารางตรวจ (เฟสถัดไป)</li>
                <li>แชร์ลิงก์ /guard/[slug] จากแท็บลิงก์ (แพ็กรายเดือน)</li>
              </ol>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-orange-700">
                <li>แดชบอร์ด — สถิติคลิกได้ · จุดตรวจ · สายตรวจ · เหตุการณ์ · กะ · แผนที่</li>
                <li>การจัดการ — จุดตรวจ · ตาราง · พนักงาน · เหตุการณ์ · ผู้ติดต่อ · อุปกรณ์</li>
                <li>การเงิน — รายรับ–รายจ่าย · หมวด (เฟส E)</li>
                <li>ตั้งค่า — พื้นฐาน · การเงิน · เว็บ · เวลา · ลิงก์/QR (รายเดือน)</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <p>
                GPS เข้มงวด · LINE Notify · สแกนกล้อง · บันทึกสายตรวจจริง — จะเปิดในเฟสถัดไป
              </p>
            ),
          },
        ]}
