...
export type MediaRegistryStatTone = "slate" | "blue" | "green" | "amber" | "rose" | "violet";

const toneStyles: Record<MediaRegistryStatTone, string> = {
  violet:
...
export function MediaRegistryStatCard({
  title,
  value,
  subtitle,
  tone = "slate",
