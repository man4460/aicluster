...
export {
  appMobileDockBackdropClass as educareMobileDockShellClass,
  appMobileDockPillClass as educareMobileDockPillClass,
  appMobileDockGridClass as educareMobileDockGridClass,
  appMobileDockItemActiveClass as educareDockItemActiveClass,
  appMobileDockItemIdleClass as educareDockItemIdleClass,
