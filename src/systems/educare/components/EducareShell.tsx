        ...
        sections={[
          {
            ...
            content: (
              <>
                <p>
                  ตั้งค่าโรงเรียนและเวลาเช็ค → เพิ่มห้องเรียนและนักเรียนใน{" "}
                  <strong className="font-semibold text-[#2e2a58]">จัดการห้องเรียน</strong> → เปิด{" "}
                  <strong className="font-semibold text-[#2e2a58]">เช็คประจำวัน</strong> ทุกเช้า → ดูสรุปที่{" "}
                ...
                <ol className="list-decimal space-y-1.5 pl-5 marker:font-semibold marker:text-[#4d47b6]">
                  <li>จัดการห้องเรียน → ตั้งค่า — ชื่อโรงเรียน · เวลาเช็คแต่ละช่วง · เปิด/ปิดการแจ้งเตือน</li>
                  <li>เพิ่มห้องเรียน — ชื่อห้อง · ระดับชั้น · ครูประจำชั้น</li>
                  <li>เพิ่มนักเรียน — ชื่อ · รูป · ข้อมูลผู้ปกครอง · ผูกห้องเรียน</li>
                  <li>เช็คประจำวัน — เริ่มจาก «เช็คเข้าแถว» ก่อนเสมอ · แล้วเช็คฟีเจอร์อื่นตามลำดับ</li>
                  <li>แดชบอร์ด — ดูสถิติวันนี้ก่อนเข้าห้อง · รายงาน — ส่งออก CSV/PDF รายเดือน</li>
                </ol>
              </>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>
                  <strong>แดชบอร์ด</strong> — สถิติมา/ขาด/ลา/สาย · กิจกรรม · กราฟ 7 วัน · นักเรียนเสี่ยง
                </li>
                <li>
                  <strong>เช็คประจำวัน</strong> — เลือกห้อง · เช็ค 6 ฟีเจอร์ · ทุกคนมา/ผ่าน
                </li>
                <li>
                  <strong>จัดการห้องเรียน</strong> — นักเรียน · ห้องเรียน · ตั้งค่าโรงเรียน
                </li>
                <li>
                  <strong>รายงาน</strong> — สรุปรายเดือน/ห้อง/บุคคล · ส่งออก · พิมพ์
                </li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>การ์ดสรุปวันนี้ — มา · ขาด · ลา · สาย (กริด 2 คอลัมน์บนมือถือ)</li>
                <li>เปอร์เซ็นต์ความเรียบร้อย — อาหาร · นม · แปรงฟัน · กิจกรรมอื่นตามที่เปิดใช้</li>
                <li>กราฟ 7 วันย้อนหลัง — ดูแนวโน้มการมาเรียน</li>
                <li>รายชื่อเตือน — นักเรียนขาดบ่อย · มาเรียนสม่ำเสมอ · ใช้คุยกับผู้ปกครอง</li>
                <li>ทางลัดไปเช็คประจำวันหรือรายงานจากการ์ดหัว (มือถือเป็นไอคอน)</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>เลือกห้องเรียนก่อน — ระบบโหลดรายชื่อนักเรียนในห้องนั้น</li>
                <li>ฟีเจอร์เช็ค (ตามลำดับแนะนำ): เช็คเข้าแถว → เรียบร้อย → ดื่มนม → อาหาร → แปรงฟัน → อื่น ๆ</li>
                <li>เช็คทีละคน — มา/ขาด/ลา/สาย · หรือกด «ทุกคนมา» / «ทุกคนผ่าน» เพื่อความเร็ว</li>
                <li>นักเรียนที่ขาดใน «เช็คเข้าแถว» จะไม่ต้องเช็คฟีเจอร์อื่นซ้ำ — ลดงานครู</li>
                <li>บันทึกอัตโนมัติตามการแตะ — ตรวจวันที่ใช้เวลาไทย (Asia/Bangkok)</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>
                  <strong>นักเรียน</strong> — เพิ่ม/แก้ไข/ปิดใช้งาน · รูป · เบอร์ผู้ปกครอง · ย้ายห้อง · กรองสถานะ
                </li>
                <li>
                  <strong>ห้องเรียน</strong> — ชื่อห้อง · ระดับชั้น · ครูประจำชั้น · จำนวนนักเรียน
                </li>
                <li>
                  <strong>ตั้งค่า</strong> — ชื่อโรงเรียน · เวลาเช็คมาตรฐานแต่ละช่วง · เปิด/ปิดการแจ้งเตือน
                </li>
                <li>ปิดใช้งานนักเรียนแทนลบ — เก็บประวัติเช็คย้อนหลัง</li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <ul className="list-disc space-y-1.5 pl-5 marker:text-[#4d47b6]">
                <li>สรุปรายเดือน · รายห้องเรียน · รายบุคคล — เลือกช่วงวันที่</li>
                <li>กรองตามห้อง · สถานะ · ฟีเจอร์ที่เช็ค</li>
                <li>ส่งออก CSV — เปิดใน Excel · ส่งผู้บริหาร/ผู้ปกครอง</li>
                <li>พิมพ์/PDF — ใช้รายงานประจำเดือนหรือประชุมผู้ปกครอง</li>
                <li>ตรวจ «ขาดบ่อย» จากแดชบอร์ดแล้วเจาะรายบุคคลในรายงาน</li>
              </ul>
            ),
          },
        ]}
