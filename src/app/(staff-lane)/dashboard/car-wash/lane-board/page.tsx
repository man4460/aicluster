...
/** ลานล้างวันนี้เต็มจอ — อัปเดตสถานะแบบ SSE (ต้องล็อกอิน) */
export default async function CarWashLaneBoardPage() {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-[#eef0ff] via-[#f7f5ff] to-[#e8f4ff]">
      <CarWashDashboard
