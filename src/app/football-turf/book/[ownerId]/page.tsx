...
export default async function FootballTurfBookingPage({ params, searchParams }: Props) {
  ...
  return (
    <FootballTurfBookingPortalClient ownerId={ownerId} trialSessionId={trialSessionId} />
  );
}
