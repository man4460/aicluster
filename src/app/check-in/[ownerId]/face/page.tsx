...
/** ลิงก์แยกสำหรับ iPad ที่จุด — เฉพาะสแกนใบหน้า (วิธีเดิมอยู่ที่ /check-in/[ownerId]) */
export default async function PublicAttendanceFaceKioskPage({ params, searchParams }: Props) {
