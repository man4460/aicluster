    ...
    <div className="space-y-4 sm:space-y-6">
      <header className="app-surface relative overflow-hidden rounded-3xl border border-white/70 px-5 py-6 shadow-[0_16px_48px_-24px_rgba(79,70,229,0.2)] sm:px-8 sm:py-7">
        ...
        <div className="relative mt-3">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#66638c]">Profile</p>
          <h1 className="mt-1 text-2xl font-black tracking-tight text-[#2e2a58] sm:text-3xl">โปรไฟล์</h1>
        </div>
      </header>
      <ProfileEditor
        initial={{
