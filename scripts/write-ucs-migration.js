const fs = require("fs");
const path = "prisma/migrations/20260911120000_used_car_showroom_module/migration.sql";

const sql = `-- Used car showroom module (group 1)
...
console.log("written", buf.length, "bom?", buf[0] === 0xef);
fs.writeFileSync(
  "tmp-ucs-del.sql",
  "DELETE FROM _prisma_migrations WHERE migration_name = '20260911120000_used_car_showroom_module';\n",
  { encoding: "utf8" },
);
